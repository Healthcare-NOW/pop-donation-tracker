from test.factories import CandidateFactory
from app.schemas import candidates_schema


def test_state_summary_with_some_candidates(test_client):
    house_candidate_1 = CandidateFactory(office='H', office_district='02', office_state='MA')
    house_candidate_2 = CandidateFactory(office='H', office_district='02', office_state='MA')
    house_candidate_3 = CandidateFactory(office='H', office_district='03', office_state='MA')
    ...
    assert resp.get_json() == {
        ...
        'house': [
            {
                'district': '02',
                'candidates': candidates_schema.dump([house_candidate_1, house_candidate_2])
            },
            {
                'district': '03',
